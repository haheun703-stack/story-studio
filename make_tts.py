"""
30장면 TTS 나레이션 생성 (Gemini 2.5 Flash TTS)
"""
...
def main():
    # 확장 시나리오 로드
    with open(EPISODE_DIR / "scenario_expanded.json", "r", encoding="utf-8") as f:
        data = json.load(f)

    scenes = data["scenes_expanded"]
